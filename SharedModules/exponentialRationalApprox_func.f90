module exponentialRationalApprox_func
  ...
  real(defReal), parameter :: c1n = -1.0000013559236386308, c2n = 0.23151368626911062025,&
          ...
          c6n = 0.0010360973791574984608, c7n = -0.000013276571933735820960
  ...
  real(defReal), parameter :: c0d = ONE, c1d = -0.73151337729389001396, c2d = 0.26058381273536471371, &
          c3d = -0.059892419041316836940, c4d = 0.009070188241094279067, c5d = -0.0012623388962473160860, &
...
end module exponentialRationalApprox_func
