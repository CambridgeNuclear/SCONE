module aceNeutronNuclideUni_class
  ...
  !! Public Pointer Cast
  !!
  public aceNeutronNuclideUni_CptrCast
  ...
  !!
  type, public, extends(ceNeutronNuclide) :: aceNeutronNuclideUni
...
contains
  ...
  function invertInelastic(self, E, rand) result(MT)
    ...
    character(100), parameter :: Here = 'invertInelastic (aceNeutronNuclideUni_class.f90)'
  ...
  function xsOf(self, MT, E) result(xs)
    ...
    character(100), parameter :: Here = 'xsOf (aceNeutronNuclideUni_class.f90)'
  ...
  elemental subroutine kill(self)
    class(aceNeutronNuclideUni), intent(inout) :: self
    integer(shortInt)                          :: i
  ...
  subroutine search(self, idx, f, E)
    ...
    real(defReal), intent(in)               :: E
    character(100), parameter :: Here = 'search (aceNeutronNuclideUni_class.f90)'
  ...
  subroutine init(self, ACE, nucIdx, database)
    ...
    character(100), parameter :: Here = "init (aceNeutronNuclideUni_class.f90)"
  ...
  !!
  pure function aceNeutronNuclideUni_CptrCast(source) result(ptr)
    class(nuclideHandle), pointer, intent(in) :: source
    class(aceNeutronNuclideUni), pointer         :: ptr

    select type(source)
      class is(aceNeutronNuclideUni)
        ptr => source
  ...
  end function aceNeutronNuclideUni_CptrCast
