module aceNeutronDatabaseUniIdx_iTest
...
contains
  ...
  !!
@Test
  subroutine test_aceNeutronDatabaseUniIdx()
    type(aceNeutronDatabaseUniIdx), target :: data
  ...
  end subroutine test_aceNeutronDatabaseUniIdx

end module aceNeutronDatabaseUniIdx_iTest
