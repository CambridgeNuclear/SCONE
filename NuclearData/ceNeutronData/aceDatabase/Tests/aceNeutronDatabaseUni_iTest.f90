module aceNeutronDatabaseUni_iTest
  ...
  use ceNeutronMaterialUni_class,  only : ceNeutronMaterialUni, ceNeutronMaterialUni_TptrCast
  use ceNeutronNuclide_inter,      only : ceNeutronNuclide, ceNeutronNuclide_CptrCast
  use aceNeutronNuclideUni_class,  only : aceNeutronNuclideUni, aceNeutronNuclideUni_TptrCast
...
contains
  ...
  !!
@Test
  subroutine test_aceNeutronDatabaseUni()
    type(aceNeutronDatabaseUni), target :: data
    ...
    type(aceNeutronNuclideUni), pointer :: nuc2
    ...
    @assertNotAssociated( ceNeutronMaterialUni_TptrCast( data % getMaterial(0)))
    @assertNotAssociated( ceNeutronMaterialUni_TptrCast( data % getMaterial(-4)))
    @assertNotAssociated( ceNeutronMaterialUni_TptrCast( data % getMaterial(3)))

    ! Get water
    mat => ceNeutronMaterialUni_TptrCast( data % getMaterial(1))
    ...
    ! Get UO2
    mat => ceNeutronMaterialUni_TptrCast( data % getMaterial(2))
    @assertAssociated(mat)
    ...
    !          3 -> H-1
    do i=1,3
      nuc2 => aceNeutronNuclideUni_TptrCast( data % getNuclide(i))
  ...
  end subroutine test_aceNeutronDatabaseUni

end module aceNeutronDatabaseUni_iTest
