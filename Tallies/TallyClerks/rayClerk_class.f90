module rayClerk_class
  ...
  !!
  !! Estimator of reaction rates used with random ray calculations.
  !! Takes a scalar flux produced at a point in space/energy and
  ...
  !! }
  !!
  type, public, extends(tallyClerk) :: rayClerk
    private
...
contains
  ...
  subroutine init(self, dict, name)
    class(rayClerk), intent(inout)        :: self
  ...
  subroutine reportInColl(self, p, xsData, mem, virtual)
    ...
    character(100), parameter :: Here = 'reportInColl (rayClerk_class.f90)'

    ! Ignores virtual collision flag
    ...
    ! Particle weight is assumed to be flux * volume
    flux = p % w
  ...
  subroutine display(self, mem)
    ...
    print *, 'rayClerk does not support display yet'
